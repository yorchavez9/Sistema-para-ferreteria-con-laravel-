...
export default function Edit({ brand }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        put(`/brands/${brand.id}`, {
            onSuccess: () => {
                showSuccess('¡Marca actualizada!', 'La marca ha sido actualizada exitosamente.');
            },
            onError: () => {
                showError('Error al actualizar', 'No se pudo actualizar la marca.');
            }
        });
    };
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Editar', href: `/brands/${brand.id}/edit` },
    ];
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex gap-4">
                                <Button type="submit" disabled={processing}>
                                    {processing ? 'Guardando...' : 'Actualizar Marca'}
                                </Button>
