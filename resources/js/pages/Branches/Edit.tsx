...
export default function Edit({ branch }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        put(`/branches/${branch.id}`, {
            onSuccess: () => {
                showSuccess('¡Sucursal actualizada!', 'La sucursal ha sido actualizada exitosamente.');
            },
            onError: () => {
                showError('Error al actualizar', 'No se pudo actualizar la sucursal.');
            }
        });
    };
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Editar', href: `/branches/${branch.id}/edit` },
    ];
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex gap-4">
                                <Button type="submit" disabled={processing}>
                                    {processing ? 'Guardando...' : 'Actualizar Sucursal'}
                                </Button>
